...
@section('content')
    ...
    <div class="row align-items-center justify-content-center vh-85 text-center">
        <h2 class= "text-center">¡Hola! Somos la primera comunidad fem con frases de empoderamiento</h2>
        <span>1</span>
        ...
        <div>
            <img src="http://localhost:8888/crud-laravel/assets/quotelogo.png"  alt="">
